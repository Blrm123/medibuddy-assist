...
import { bookAppointment, type BookAppointmentResponse } from "@/actions/appointments";
...
export function AppointmentForm({
  ...
  const { loading, data, fn: submitBooking } = useFetch<BookAppointmentResponse, [FormData]>(
    bookAppointment
  );

                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {(doctor.specialty ?? "Not specified")} • {(doctor.experience ?? "N/A")} years experience
                          </p>
                        </div>
                      </div>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="space-y-1 flex-1">
                  ...
                  <p className="text-base font-medium text-white">{selectedDoctor.name ?? "Unnamed"}</p>
                </div>
                <div className="space-y-1 flex-1">
                  <h4 className="text-sm font-medium text-muted-foreground">
                    Email
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6">
                  <div className="space-y-1">
                    ...
                    <p className="text-white">{selectedDoctor.specialty ?? "Not specified"}</p>
                  </div>

...
export function PendingPayouts({ payouts }: { payouts: Payout[] }) {
  ...
  // hook for calling server action
            ...
            <div className="space-y-6 py-4">
              ...
              {selectedPayout.doctor.credits < selectedPayout.credits && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Doctor only has {selectedPayout.doctor.credits} credits but needs{" "}
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This action will deduct credits and process payout.
              </DialogDescription>
            </DialogHeader>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <ul className="mt-2 space-y-1 list-disc pl-4">
                    ...
                    <li>Mark payout as PROCESSED</li>
            ...
            <DialogFooter>
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Check className="mr-2 h-4 w-4" /> Confirm Approval
                  </>
                )}
              </Button>
            </DialogFooter>

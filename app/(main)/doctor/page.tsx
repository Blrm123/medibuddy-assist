...
import { Appointment as AppointmentCardAppointment } from "@/components/appointment-card";
      ...
      <div className="md:col-span-3">
        <TabsContent value="appointments" className="border-none p-0">
          <DoctorAppointmentsList
            appointments={
              (appointmentsData.appointments || []) as unknown as AppointmentCardAppointment[]
            }
          />
        </TabsContent>
